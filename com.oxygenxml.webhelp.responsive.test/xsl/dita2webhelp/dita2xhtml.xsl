...
<xsl:stylesheet version="2.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
  ...
  <xsl:import href="plugin:com.oxygenxml.webhelp.responsive:xsl/dita2webhelp/rel-links.xsl"/>
  ...
  <xsl:include href="plugin:com.oxygenxml.webhelp.responsive:xsl/review/review-elements-to-html.xsl"/>
