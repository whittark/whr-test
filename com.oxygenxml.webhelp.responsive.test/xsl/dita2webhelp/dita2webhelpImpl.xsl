...
<xsl:stylesheet 
  ...
  <!-- Basic processing -->  
  <xsl:import href="plugin:com.oxygenxml.webhelp.responsive:xsl/dita2webhelp/fixup.xsl"/>

  <!-- Add navigation links like side toc(mini toc) or breadcrumb-->
  <xsl:import href="plugin:com.oxygenxml.webhelp.responsive:xsl/dita2webhelp/dita2xhtml.xsl"/>
  <xsl:import href="plugin:com.oxygenxml.webhelp.responsive:xsl/util/macroExpander.xsl"/>
  
  <!-- Apply selected template -->
  <xsl:import href="plugin:com.oxygenxml.webhelp.responsive:xsl/template/topicComponentsExpander.xsl"/>
 ...
 <!-- <xsl:import href="template:xsl/com.oxygenxml.webhelp.responsive.xsl.dita2webhelp"/>-->
  ...
  <xsl:variable name="hazIcon" select="'img/hazard_triangle_inline_2.png'"/>
