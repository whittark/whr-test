...
<xsl:stylesheet version="2.0" 
                ...
                exclude-result-prefixes="dita-ot topicpull ditamsg xs oxygen">
  <xsl:import href="plugin:com.oxygenxml.webhelp.classic:xsl/functions.xsl"/>
...
<xsl:import href="plugin:org.dita.base:xsl/common/dita-textonly.xsl"/>
  ...
  <xsl:key name="count.topic.section"
